...
import { numberToLocaleCurrencyString, numberToLocaleString } from "../../../../util/utils"
import './evolucao-patrimonio-bar-chart.scss'

const EvolucaoPatrimonioBarChart = ({ chartData }:{ chartData:any}) => {
        ...
        // if (!chartData){
            ...
            setOptions({
                ...
                dataLabels: {
                    enabled: true,
                    formatter: (val:any) => {
                        return numberToLocaleString(val,2);
                    },
                    enabledOnSeries: [0]
                },
