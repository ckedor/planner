...
import { numberToLocaleCurrencyString, sortArrayByProperty, sumObjectArrayProperty } from '../../../../util/utils';
import styles from './gastos-pie-chart.module.scss';

const GastosPieChart = ({chartData, receitas }:{chartData:any, receitas:any}) => {
    ...
    const mountChart = () => {
        ...
        setSeries(chartData.map( (obj:any) => obj.gastoTotal))
        const labels = chartData.map( (obj:any) => obj.categoria)
        setOptions( {
            chart: {
                width: 380,
                type: 'pie',
    ...
    return (
        <>
        <div className={styles.gastos_pie_chart}>
            <div className="row">
