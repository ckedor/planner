...
from financas.viewsets import CategoriaGastoViewSet, GastoViewSet, GastosOnCurrentMonth, SubCategoriaGastoViewSet
...
router.register(r'financas/gastos', GastoViewSet)

urlpatterns = [
    path('', include(router.urls)), 
    path('admin/', admin.site.urls),
    path('auth/', views.obtain_auth_token, name='auth'),
    path('financas/gastos_mes', GastosOnCurrentMonth.as_view()),
]